...
function Profile() {
  ...
  async function customerProfileAxios() {
    ...
    try {
      const url = `${baseURL}/customer/customerProfile`;
  ...
  async function customerProfileSearchAxios() {
    // alert(email)
    let fd = new FormData();
    fd.append("email", email);
    try {
      const url = `${baseURL}/customer/customerProfileSearch`;
  ...
  async function updateCustomerProfile() {
    ...
    try {
      ...
      const url = `${baseURL}/customer/updateCustomerProfile`;
  ...
  useEffect(() => {
    customerProfileSearchAxios(); // Fetch records 
  }, []);
